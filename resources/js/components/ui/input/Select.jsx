export default function Select({
  ...
  const disabledOptionClass = 'text-gray-700 dark:text-gray-300 bg-gray-200 dark:bg-gray-600';
  const enabledOptionClass = 'text-gray-700 dark:text-gray-400 dark:bg-gray-900';
